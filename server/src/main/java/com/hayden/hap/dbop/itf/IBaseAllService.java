package com.hayden.hap.dbop.itf;
...
public interface IBaseAllService {
	 ...
	 *            实体对象
	 * @param dataSourceId
	 *            执行操作的数据源ID, 如果不为空则直接返回该数据源ID,否则按配置的路由规则查找数据源,
	 *            如果没有路由到数据源则返回默认数据源
	 * @return
	 * @return T
	 * @throws
	...
	/**
	 * updateBatch:(批量更新，需要设置每条数据更新的列，voList.size()=dynaSqlVOList.size()). <br/>
	 * date: 2015年11月3日 <br/>
	 * 
	 * @Description: 批量更新
	 * @param voList
	...
	/**
	 * @deprecated 该方法不支持传入租户参数
	 * 后续建议使用下面方法代替：queryByPKAndTenantid(T vo, Long primaryKey, Long tenantid, String ruleName, String dataSourcePoolName)
	 * @Title: queryByPK
	 * @Description: 按主键查询
	 * @param vo
	 *            实体对象 这里用于获取表名而已
	...
	/**
	 * @deprecated 该方法不支持传入租户参数
	 * 后续建议使用下面方法代替：queryByPKAndTenantid(T vo, Long primaryKey, Long tenantid, String dataSourceId, 
	 * 							String ruleName, String dataSourcePoolName)
	 * @Title: queryByPK
	 * @Description: 按主键查询
	 * @param vo
...
//	public AbstractVO queryByPK4update(String tableName, Long primaryKey);
	...
	/**
	 * @deprecated 该方法不支持传入租户参数
	 * 后续建议使用下面方法代替：queryByPKAndTenantid(String tableName, Long primaryKey, Long tenantid, String dataSourceId)
	 * @Title: queryByPK
	 * @Description: 按主键查询
	 * @param tableName
	 *            表名
	...
	/**
	 * @deprecated 该方法不支持传入租户参数
	 * 后续建议使用下面方法代替：queryByPKAndTenantid(String tableName, Long primaryKey, Long tenantid, String ruleName, String dataSourcePoolName)
	 * @Title: queryByPK
	 * @Description: 按主键查询
	 * @param tableName
	 *            表名
