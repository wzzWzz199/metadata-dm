 ...
 */
public class MysqlToOracleSqlConvert implements SqlConvert{

    private static final Logger logger = LoggerFactory.getLogger(MysqlToOracleSqlConvert.class);
     ...
     * @date 2017年7月3日
     */
    private String getOracleDateFormat(String dateFormat){
