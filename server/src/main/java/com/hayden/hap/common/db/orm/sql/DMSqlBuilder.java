...
import com.hayden.hap.common.db.util.IOracleDbTypeConstants;
 ...
 *
 */
public class DMSqlBuilder extends AbstractSqlBuilder implements SqlBuilder {
    private static final Logger logger = LoggerFactory.getLogger(DMSqlBuilder.class);
    @Override
    ...
    public String getDDLDataTypeAndLength(TableColumnVO columnVO){
        ...
        String dataType = getDataTypeOfDbType(DBType.DM.getCode(), colDataType);
     ...
     * @see AbstractSqlBuilder#getColValueSqlString(TableDefVO, String, Object)
     * @author wangyi
     * @date 2017年7月6日
     */
